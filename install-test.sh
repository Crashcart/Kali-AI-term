#!/bin/bash
# Kali Hacker Bot Installation Script - TEST TIER
# Target Branch: test
# Raw URL: https://raw.githubusercontent.com/Crashcart/Kali-AI-term/test/install-test.sh
#
# Test tier: Release candidate, final validation before production
# Use this for final testing and validation before main branch promotion
#
set -e
...
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo "    Kali Hacker Bot - Installation (TEST TIER)"
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo ""

# Clone/enter repo if needed
if [ ! -f "install-test.sh" ] || [ ! -f "package.json" ]; then
  echo "📦 Cloning Kali-AI-term repository (test branch)..."
  if [ -d "Kali-AI-term" ]; then
    cd Kali-AI-term
  else
    git clone --branch test https://github.com/Crashcart/Kali-AI-term.git
    cd Kali-AI-term
  fi
fi
...
log_info "Starting installation (TEST tier)..."
...
echo ""
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo "    🎉 Installation Complete (TEST TIER)!"
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo ""
echo "✓ Test tier: Release candidate for production"
echo ""
...
echo "    4. Validate all features work correctly"
echo ""

log_success "Installation completed successfully (TEST tier)"
