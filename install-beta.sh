#!/bin/bash
# Kali Hacker Bot Installation Script - BETA TIER
# Target Branch: beta
# Raw URL: https://raw.githubusercontent.com/Crashcart/Kali-AI-term/beta/install-beta.sh
#
# Beta tier: Stable features, tested code, ready for broader testing
# Use this for stable features before final test/production promotion
#
set -e
...
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo "    Kali Hacker Bot - Installation (BETA TIER)"
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo ""

# Clone/enter repo if needed
if [ ! -f "install-beta.sh" ] || [ ! -f "package.json" ]; then
  echo "📦 Cloning Kali-AI-term repository (beta branch)..."
  if [ -d "Kali-AI-term" ]; then
    cd Kali-AI-term
  else
    git clone --branch beta https://github.com/Crashcart/Kali-AI-term.git
    cd Kali-AI-term
  fi
fi
...
log_info "Starting installation (BETA tier)..."
...
echo ""
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo "    🎉 Installation Complete (BETA TIER)!"
echo "💉 ═══════════════════════════════════════════════════════════════════ 💉"
echo ""
echo "✓ Beta tier: Stable features ready for testing"
echo ""
...
log_success "Installation completed successfully (BETA tier)"
